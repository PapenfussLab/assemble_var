---
title: "Investigating Oases Assembly"
...
```{r}
#oases approach data
# EIC_processed_contigs <- read.delim("/wehisan/home/allstaff/t/tonkin-hill.g/assembly_testing/SoapDeNovoAttempt/OASES_again/EICv2_OASES_again/analytics_output.txt")
# ECS_processed_contigs <- read.delim("/wehisan/home/allstaff/t/tonkin-hill.g/assembly_testing/SoapDeNovoAttempt/OASES_again/ECS_S27_L002/analytics_output.txt")
# CS2_processed_contigs <- read.delim("/wehisan/home/allstaff/t/tonkin-hill.g/assembly_testing/SoapDeNovoAttempt/OASES_again/CS2_S25_L002/analytics_output.txt")
...
```{r}
redundancy(ECS_processed_contigs, 1000, var_gene_lengths, 95)
```
...
```{r}
redundancy(CS2_processed_contigs, 1000, var_gene_lengths, 95)
```
...
```{r}
redundancy(EIC_processed_contigs, 1000, var_gene_lengths, 95)
```
